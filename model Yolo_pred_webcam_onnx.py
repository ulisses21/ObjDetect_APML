...
if pip_packages.find("ultralytics  " and " opencv-python "and "opencv-contrib-python" and 
                      ...
                      "onnx" and "onnxruntime" and "fiftyone-db-ubuntu2204" ) != -1:
    print("Required libs are alerty installed")
else:
    os.system('pip3 install ultralytics  opencv-python opencv-contrib-python torch torchvision torchaudio fiftyone onnx onnxruntime fiftyone-db-ubuntu2204')
